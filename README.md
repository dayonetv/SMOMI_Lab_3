...
Исходя из полученных результатов можно отметить следующее:  
  ...
  + Сравнивая же политики пошагового затухания и экспоненциального затухания, лучшего результата удалось добиться с помощью экспоненциального затухания (точность выше на 0.008 процента, скорость схождения алгоритма выше на 2 эпохи, потерь меньше на 0.0574 по сравнению с пошаговым затуханием)
