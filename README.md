...
Исходя из полученных результатов можно отметить следующее:  
  ...
  + Сравнивая же политики пошагового затухания и экспоненциального затухания, лучшего результата удалось добится с помощью  (точность выше на процента, скорость схождения алгоритма выше на эпох, потерь меньше на )
